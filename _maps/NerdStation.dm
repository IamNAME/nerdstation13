...
*/
        ...
        #include "map_files\NerdStation\NerdStation.dmm"
		...
		#define MAP_PATH "map_files/NerdStation"
        #define MAP_FILE "NerdStation.dmm"
        #define MAP_NAME "Nerd Station 13"
	...
	#warn a map has already been included, ignoring NerdStation.
